...
mod=Path('/tmp/test_dg_wpw_builder_transactions_mod');mod.mkdir(exist_ok=True)
exe=Path('/tmp/test_dg_wpw_builder_transactions')
sources=['src/common/dg_wpw_owner_exchange.f90','src/common/dg_wpw_bounded_operator.f90',
 ...
 'src/rt/dg/rt_dg_wpw_trace_halo_provider.f90','src/rt/dg/rt_dg_wpw_candidate_halo.f90',
 'src/rt/dg/rt_dg_wpw_production_builder.f90',
 'tests/dg/test_dg_wpw_builder_transactions.f90']
