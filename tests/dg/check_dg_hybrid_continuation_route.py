...
continuation_end = shared_route.index("endif", shared_branch_position)
divided_end = shared_route.index("if(yn_dg_hybrid_scf=='y')then", continuation_end)
continuation_arm = shared_route[shared_branch_position:continuation_end]
divided_arm = shared_route[continuation_end:divided_end]
