...
mod=Path('/tmp/test_dg_wpw_face_trace_reduce_mod');mod.mkdir(exist_ok=True)
exe=Path('/tmp/test_dg_wpw_face_trace_reduce_mpi')
sources=['src/common/dg_wpw_owner_exchange.f90','src/common/dg_wpw_bounded_operator.f90',
 ...
 'src/rt/dg/rt_dg_wpw_trace_halo_provider.f90','tests/dg/test_dg_wpw_face_trace_reduce_mpi.f90']
