program test_dg_dc_handoff_mpi
  ...
  call require_collective(.not.accept,'rank-disagreeing gate diagnostics')
  call evaluate_dg_dc_handoff(handoff,3,5.0d-4,4.0d0,4.0d0,.true.,.false.,.false.,.false., &
                              MPI_COMM_WORLD,accept,message)
  call require_collective(accept,'agreed gate diagnostics')
