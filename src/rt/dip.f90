...
!===================================================================================================================================
subroutine subdip(comm,itt,rt,lg,mg,srho,rNe,poisson,Etot,system,pp)
  ...
  call calc_dip(comm,lg,mg,srho,rbox_array2)
...
subroutine calc_dip(comm,lg,mg,srho,rbox_array2)
