...
!
!  Built-in r2SCAN meta-GGA exchange-correlation, implemented from the
!  published formulas (not derived from any external code):
!    r2SCAN: J. W. Furness, A. D. Kaplan, J. Ning, J. P. Perdew, J. Sun,
!            J. Phys. Chem. Lett. 11, 8208 (2020).
!    SCAN (f(alpha) interpolation): J. Sun, A. Ruzsinszky, J. P. Perdew,
