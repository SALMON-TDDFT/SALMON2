...
do is=1,iss
  do iob=iobsta(is),iobend(is)-1
    ...
    if(iob/=imin)then
      ...
      esp(imin,iik)=rbox
      matbox1=0.d0
      call check_corrkob_ud(iob,iik,icheck_corrkob,ilsda,nproc_ob,iparaway_ob,itotmst,k_sta,k_end,nproc_ob_spin,mst)
      ...
      matbox3=0.d0
      call check_corrkob_ud(imin,iik,icheck_corrkob,ilsda,nproc_ob,iparaway_ob,itotmst,k_sta,k_end,nproc_ob_spin,mst)
