...
subroutine sgscg(mg,spsi,iflag,itotmst,mst,hvol,ilsda,nproc_ob,nproc_ob_spin,iparaway_ob,  &
                 rxk_ob,rhxk_ob,rgk_ob,rpk_ob,elp3)
...
type(s_wavefunction),intent(inout) :: spsi
  ...
  real(8),intent(out)    :: rxk_ob(mg%is(1):mg%ie(1),mg%is(2):mg%ie(2),mg%is(3):mg%ie(3),1:spsi%numo)
  real(8),intent(out)    :: rhxk_ob(mg%is(1):mg%ie(1),mg%is(2):mg%ie(2),mg%is(3):mg%ie(3),1:spsi%numo)
  real(8),intent(out)    :: rgk_ob(mg%is(1):mg%ie(1),mg%is(2):mg%ie(2),mg%is(3):mg%ie(3),1:spsi%numo)
  real(8),intent(out)    :: rpk_ob(mg%is(1):mg%ie(1),mg%is(2):mg%ie(2),mg%is(3):mg%ie(3),1:spsi%numo)
