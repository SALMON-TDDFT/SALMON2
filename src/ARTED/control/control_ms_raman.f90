...
!xx  ! Output filename
!xx  write(file_energy_transfer, "(A,'energy-transfer.data')") trim(base_directory)
...
!xx    & call comm_summation(jm_ion_new_m_tmp, Jm_ion_new_m, 3*nmacro,nproc_group_global)
    ...
    !===========================================================================
!xx    call timer_begin(LOG_RT_MISC)
