...
void stencil_c_tuned_omp_imp( const int PNLx
                            , const int PNLy
                            , const int PNLz
                            , const int NLx
                            , const int NLy
...
#pragma omp parallel for collapse(2) default(none) \
                         private(yz_table) \
                         firstprivate(NLx,NLy,NLz,NSx,NSy,NSz) \
                         firstprivate(G,D,isx,iex,isy,iey,isz,iez) \
                         firstprivate(at,HALF,INV,nly,nlx,nyz,nlyx) \
                         shared(B,E,F,modx,mody,modz)
#pragma noprefetch
#pragma novector
 ...
 * ie      : one origin
 */
void stencil_c_tuned_omp_( int            const            is_array[restrict 3]
...
#undef INT_ABS
  ...
  stencil_c_tuned_omp_imp(PNLx, PNLy, PNLz, NLx, NLy, NLz, NHx, NHy, NHz, modx, mody, modz
                         , A_
