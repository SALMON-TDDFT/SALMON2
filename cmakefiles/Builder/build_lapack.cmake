...
if (LAPACK_VENDOR_FLAGS)
  ...
  set(SALMON_BLASLAPACK_LIBRARIES ${LAPACK_VENDOR_FLAGS})
else ()
  ...
  if (LAPACK_FOUND)
    ...
    set(SALMON_BLASLAPACK_LIBRARIES ${LAPACK_LINKER_FLAGS} ${LAPACK_LIBRARIES})
  else ()
    ...
    set(SALMON_BLAS_LIBRARY ${CMAKE_CURRENT_BINARY_DIR}/lib64/libblas.a)
    set(SALMON_LAPACK_LIBRARY ${CMAKE_CURRENT_BINARY_DIR}/lib64/liblapack.a)
    set(SALMON_BLASLAPACK_LIBRARIES ${SALMON_LAPACK_LIBRARY} ${SALMON_BLAS_LIBRARY})
    set(SALMON_LAPACK_BUILD_TARGET lapack-project-install)
  endif ()
endif ()
